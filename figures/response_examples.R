...
#gameID <- "gid_2017_08_13_minmlb_detmlb_1" # Figure C
gameID <- "gid_2017_08_15_cinmlb_chnmlb_1" # Figure D
...
ggsave("figures/response_examples.pdf", plot = grid.arrange(ebzlplot, ebzrplot, ncol=2), 
